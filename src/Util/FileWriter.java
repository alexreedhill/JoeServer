...
public class FileWriter {
    ...
    public byte[] writePartialContent(byte[] fileContents) throws Exception {
        ...
        writeWithFileOutputStream(fileContents);
        return newFileContents;
    }

    private void checkContentLengths(int requestContentLength, byte[] fileContents) {
    ...
    private void writeWithFileOutputStream(byte[] fileContents) throws Exception {
